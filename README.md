...
## Overview
### Description
Tracks what books an individual has been reading, and recommend them other books based on their book interests. Could be potentially used as a digital and physical book manager feed by social aspects, or just a recommendation book center.
...
- **Habit:** This app could be used as often or unoften as the user wanted depending on the time the user decides to dedicate to reading books.
- **Scope:** First, I would start with recommending books based on book taste, then perhaps this could evolve into a library locator application as well to broaden its usage. Large potential for use collages and public libraries.
...
* User can add a certain book to their shelf of owning books.
* User can establish on what page they're on for any given book their own.
...
* User can add a book to his library by importing the ISBN code of said book.
...
* Library screen
   ...
   * User can establish on what page they're on for any given book their own.
    ...
    * User can add a book to his library by importing the ISBN code of said book. (Optional)
...
* Fovourite books selection -> Discover screen
